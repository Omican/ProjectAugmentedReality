...
import com.par.projectaugmentedreality.utils.VideoBackgroundShader;
...
public class AppRenderer {
    ...
    void initRendering()
    {
        ...
        if (vbShaderProgramID > 0)
        {
            ...
            // Retrieve handler for texture r shader uniform variable:
            vbTexr2DHandle = GLES20.glGetUniformLocation(vbShaderProgramID, "texr2D");
    ...
    public void renderVideoBackground()
    {
        ...
        GLES20.glUniform1i(vbTexr2DHandle, vbVideoTextureUnit);
